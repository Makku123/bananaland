  ...
  // 2: Dice & Movement
  {
    ...
    render() {
      return `
        ...
        <p>Each turn you <span class="tut-highlight">roll 2 dice</span> and move their sum.</p>
        <div class="tut-dice-demo">
          <div class="tut-die" onclick="tutRollDie(this)">3</div>
          <div class="tut-die" onclick="tutRollDie(this)">5</div>
        </div>
        <p>If your <span class="tut-highlight">roll number equals a revealed GROW's number</span> (1–6), that GROW fires <strong>before you move</strong>. Hidden GROWs stay dormant.</p>
